...
#if defined(NDEBUG)
# error "BLUEBOX cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 1200;
...
const string strMessageMagic = "BLUEBOX Signed Message:\n";
